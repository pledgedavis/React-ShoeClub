...
Shoe.create(name: 'Yeezy Turtle Dove', image:'https://sneakernews.com/wp-content/uploads/2016/12/adidas-yeezy-boost-350-turtle-dove-release-info-history.jpg', description: 'First Yeezy Adida ever')
Shoe.create(name: 'Yeezy Solar Red', image:'https://i.ytimg.com/vi/guCMp3-UVD0/maxresdefault.jpg', description: 'First Nike yeezy to release')
...
Shoe.create(name: 'Nike cortez', image:'https://i.pinimg.com/originals/96/e7/08/96e708a9396cdb4bfcc01c94692154b9.png', description: 'The forest gump worn shoes')
